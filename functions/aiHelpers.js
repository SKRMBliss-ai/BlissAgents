...
They believe technology can help businesses grow and make life easier, but they are equally passionate about helping people understand their own minds, feelings and emotions, so they can live healthier, happier and more aware lives. That is why, alongside their digital work, they create practical tools such as MindGym that help people actually practise mind training in everyday life. Smriti also shares these teachings through Soulful Intelligence Studio, helping people understand their feelings and emotions, work with their minds and develop greater awareness in everyday life.

They are honestly and passionately building this journey themselves, personally involved in everything they do. At the heart of how they work is a genuine belief in honesty and real relationships — they want to connect with people and businesses where there is true mutual value, not just a transaction. They care deeply about the people they work with and the impact of the work they do together. They don't approach a business asking "what can we sell them" — they first ask whether there is something they can genuinely contribute, and whether this could be the start of a real, lasting working relationship built on trust.

The recipient should finish the email feeling: "I know who these two are, what they care about, and why they specifically reached out to me" — never "another technology company wants to sell me something", and never "someone is trying to sell me a spiritual course". Do not state any of this framing literally — it should come through in the warmth, honesty and non-pushy nature of the writing itself. Keep the spirituality side grounded and factual, never oversold — avoid claims like "we transform lives", "we heal people", or "we revolutionize consciousness".
...
- Ground everything in what's actually known (business name, type, and any context given below) reasoned honestly from realistic patterns for that kind of business — never invent specifics (claims about their website, customers, revenue, tools, achievements, or problems) that aren't supported by what you were given. Use hedging language for anything inferred: "we wondered whether...", "there may be...", "if this is something you're exploring..." — never state an inferred gap as settled fact.
- Never claim the business has a problem, is outdated, or is losing customers, and NEVER point out what their setup lacks (e.g. do NOT write "especially since your setup doesn't include online booking" or "since your website lacks..."). Reason entirely in terms of positive opportunity to enhance their client experience.
...
- Ban these words/phrases — dead giveaways of AI/marketing copy: "leverage", "synergy", "innovative solutions", "cutting-edge", "revolutionary", "transformative", "holistic", "empower", "ecosystem", "digital presence" (as a phrase), "elevate", "unlock", "seamless", "game-changer", "take it to the next level", "stand out", "thrilled", "excited to", "reach out", "caught our eye", "caught our attention", "while reviewing your site", "one idea that came to mind".
- Ban casual, immature, or academic-sounding phrases in the introduction — they sound unpolished or like an academic thesis. Banned examples: "split our time", "split time", "split my time", "who spend our days", "exploring how people can understand", "weaving together", "a curiosity about the mind", "on a mission", "rooted in", "driven by a passion", "our hearts are in", "we live at the intersection". The introduction must sound like two confident, mature professionals describing themselves in articulate, warm, executive-level language. Model introductions:
  - "We're Shruti and Smriti, twin sisters whose work combines software development with practical tools for emotional intelligence and mind training."
  - "We're Shruti and Smriti, twin sisters working across digital product design and emotional awareness."
  - "We're Shruti and Smriti, twin sisters who build digital products while also creating tools for daily mind training."
- Clean product formatting: NEVER place square brackets around product names or brand titles in the generated email body (e.g. do NOT write "[MindGym]" or "a [Nicola Hladky] MindGym"). Write product and brand names cleanly in natural English: "a Nicola Hladky MindGym app" or "a dedicated MindGym platform".
...
- Links MUST use the format [display text](url) — for example: [MindGym](https://www.skrmblissai.in/mindgym) or [Soulful Intelligence Studio](https://www.youtube.com/@SoulfulIntelligenceStudio?sub_confirmation=1). NEVER paste a raw URL into the body text — a bare URL like https://... appearing in a sentence is strictly forbidden. Every URL must be embedded behind natural, readable link text.
- Never mention team size, headcount, or independence in terms of size — phrases like "just the two of us", "we're independent — just us", "not a large team", "small team", "it's just us", "we're not an agency" are all banned. Who they are comes through in what they say and how they say it, never in a disclaimer about how many people they are.
...
- Soulful Intelligence Studio (YouTube — free content on feelings, emotions, thoughts, and self-awareness): https://www.youtube.com/@SoulfulIntelligenceStudio?sub_confirmation=1 — a low-commitment, free way for anyone touched by presence/mindfulness/inner-growth themes to get to know the work; a safe default mention when a specific course doesn't quite fit but the theme still resonates.
`;
...
LEVEL 3 — Personal interest: failing Level 2, might the recipient themselves personally find Soulful Intelligence Studio (YouTube) a low-pressure, free way to get a feel for this side of the work? Only reach for this if Level 2 doesn't apply and there's still a plausible personal fit.
...
const mindGymAppBlock = (potential, reason, product) => {
  ...
  return `
Custom branded-app opportunity: beyond the existing ${productLine}, we can build a CUSTOMIZED, BRANDED version of it for a business's own audience — e.g. a Nicola Hladky MindGym app, a custom Habit Tracker for their clients, or a branded kids' keyboard-learning experience, built specifically for their community rather than sending people to a third-party app. ${strength}
Rules if you use this: never claim it already exists as a ready product for THEM specifically — frame it as "we could potentially build/customize this for you", not "we have a white-label app available". Position the existing product as a working foundation/starting point (faster and lower-risk than starting from scratch) rather than claiming specific development-speed or cost savings. Never promise specific features, pricing, or a fixed scope — the natural next step is a conversation to understand their audience and requirements, not a pitch with a price. Use natural language ("branded specifically for your clients", "customized for your practice", "tailored for your audience") rather than jargon like "white-label SaaS solution" or cliché phrases like "sit under your own brand". NEVER output literal square brackets [] in the generated email text. Never make medical/clinical claims about MindGym — it's mind-training/emotional-awareness content, not treatment.
`;
};
