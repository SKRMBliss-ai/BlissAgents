...
- Ban these words/phrases — dead giveaways of AI/marketing copy: "leverage", "synergy", "innovative solutions", "cutting-edge", "revolutionary", "transformative", "holistic", "empower", "ecosystem", "digital presence" (as a phrase), "elevate", "unlock", "seamless", "game-changer", "take it to the next level", "stand out", "thrilled", "excited to", "reach out", "caught our eye", "caught our attention", "while reviewing your site".
- Ban casual, immature, or diary-entry phrases in the introduction — they sound unpolished and undermine professional confidence. Banned examples: "split our time", "split time", "split my time", "who spend our days", "weaving together", "a curiosity about the mind", "on a mission", "rooted in", "driven by a passion", "our hearts are in", "we live at the intersection". The introduction must sound like two confident, mature professionals describing themselves in articulate, warm, executive-level language. Model introductions:
  - "We're Shruti and Smriti, twin sisters whose work combines software development with human emotional intelligence and mind training."
