...
- Open with a brief, understated, specific observation about the business — one sentence, no superlatives ("really impressed", "truly inspiring", "wonderful", "amazing"). State what they do plainly rather than gushing over it; over-the-top praise reads as fake and can push a prospect away.
...
// ("Bangalore" to a Toronto/Dublin client) is the concrete mistake we're fixing.
...
const emailFooter = (location) =>
  `\n\nWarm regards,\n**Shruti | ${location}**\n\nMy work:\n- SKRM Bliss AI – https://www.skrmblissai.in\n- https://www.skrmblissai.in/twinsouls`;
...
1. Open with a brief, understated, specific observation about the business — one sentence, no superlatives ("really impressed", "truly inspiring", "wonderful", "amazing"). State what they do plainly rather than gushing over it; over-the-top praise reads as fake and can push a prospect away. Infer something plausible from the business type — do not invent fake stats or claims.
